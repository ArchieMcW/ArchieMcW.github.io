...
var KillerPerkDescriptions = ["Unlocks potential in one's Aura reading ability. The Auras of Survivors who are healing or being healed are revealed to you when they are within <span style='color:green'>20</span>/<span style='color:purple'>24</span>/<span style='color:purple'>28</span> meters range.",
								...
								"Unlocks potential in one's Aura reading ability. Survivors' Auras are revealed to you for a duration of <span style='color:green'>5</span>/<span style='color:purple'>7</span>/<span style='color:purple'>9</span> seconds when the Exit Gates are powered.",
								"Like a hunting scent hound, you smell traces of blood at a great distance. Fresh blood marks are <span style='color:yellow'>slightly</span>/<span style='color:green'>moderately</span>/<span style='color:purple'>considerably</span> more discernible than normal and can be tracked for 2/3/4 seconds seconds longer than normal.",
								"Your great strength allows you to shred through your prey's defences. Destroy dropped Pull-Downs <span style='color:yellow'>10</span>/<span style='color:green'>15</span>/<span style='color:purple'>20</span> % faster.",
								"Unlocks potential in one's Aura reading ability. Reveals dying Survivors' Auras when standing within <span style='color:yellow'>12</span>/<span style='color:yellow'>24</span>/<span style='color:green'>36</span> meters.",
								"Your horrifying emanation strikes at a supernaturally long distance. Your Terror Radius is increased by <span style='color:yellow'>22</span>/<span style='color:green'>24</span>/<span style='color:purple'>26</span> %. Gain <span style='color:yellow'>50</span>/<span style='color:green'>75</span>/<span style='color:purple'>100</span> % more Bloodpoints for actions in the Deviousness category. The bonus bloodpoints are only awarded post-trial.",
								"You become obsessed with one Survivor. Your Obsession's altruistic action speed is increased by <span style='color:green'>38</span>/<span style='color:purple'>44</span>/<span style='color:purple'>50</span> %. Once the Obsession is killed or sacrificed, every other Survivor gets a penalty of <span style='color:green'>19</span>/<span style='color:purple'>22</span>/<span style='color:purple'>25</span> % to repair, healing and sabotage speed. Only one Obsession per match.",
								"You are resilient to pain. Your rate of recovery from stuns is increased by <span style='color:yellow'>50</span>/<span style='color:yellow'>60</span>/<span style='color:green'>75</span> %.",
								"Your vicious attacks make the Survivors drop their Item on impact. The lost item is damaged in the fall, losing <span style='color:yellow'>0</span>/<span style='color:green'>5</span>/<span style='color:purple'>10</span> % of its base amount of Charges.",
								"Unlocks the stealth ability. By standing still for <span style='color:green'>4</span>/<span style='color:purple'>3</span>/<span style='color:purple'>2</span> seconds, you reduce your Terror Radius to <span style='color:orange'>0</span> and become stealthy until you move or act again.",
								"Your powerful hold onto the Survivors causes escapes to be nearly impossible. Effects of Survivor struggling are reduced by <span style='color:yellow'>25</span>/<span style='color:yellow'>50</span>/<span style='color:green'>75</span> %. Time to struggle out of your grasp is increased by <span style='color:yellow'>4</span>/<span style='color:yellow'>8</span>/<span style='color:green'>12</span> %.",
								...
								"A Hex that affects the Survivors' skills at repairing Generators. <span style='color:green'>2</span>/<span style='color:purple'>3</span>/<span style='color:purple'>4</span> survivors are affected by Ruin, which causes good Skill Check to result in 5% regression on the generator and great Skill Checks grant 0% in progression. The Hex effects persist as long as the related Hex Totem is standing.",
								"A Hex that hinders one's Aura reading ability. Hitting a Survivor while the Hex Totem is active reduces the effectiveness of their Aura reading ability by 100%. This effect applies to the last <span style='color:yellow'>2</span>/<span style='color:green'>3</span>/<span style='color:purple'>4</span> survivors hit. The Hex effects persist as long as the related Hex Totem is standing.",
								"A Hex rooting its power on hope. The false hope of Survivors fills you with excitement and strengthens your totems. For each Dull Totem and Hex Totem remaining on the map gain a Token.<ul><li>Gain 6/8/10 % more Bloodpoints  for actions in the Hunter category for each Token.</li><li>Survivors' cleansing speed is reduced by 4/5/6 % for each Token.</li><li>Gain a notification when someone starts working on a Hex Totem.</li><li>The Hex effects persist as long as the related Hex Totem  is standing.</li></ul>",
								...
								"The trauma caused by your brutal attacks makes crying for help painfully difficult. Dying Survivors' Auras are not revealed to other Survivors when they are standing outside of a <span style='color:yellow'>32</span>/<span style='color:yellow'>24</span>/<span style='color:green'>16</span> meter range.",
								"Unlike other beasts of the fog, you have adapted to light. Resistance to blindness is increased by <span style='color:yellow'>20</span>/<span style='color:green'>40</span>/<span style='color:purple'>60</span> %. Recovery from blindness is increased by <span style='color:red'>50%</span>.",
								...
								"Your presence alone instils great fear. Survivors within your Terror Radius suffer from inefficiency. Affected Survivors' Item consumption rates are increased by <span style='color:yellow'>80</span>/<span style='color:yellow'>90</span>/<span style='color:green'>100</span> %",
								"You become obsessed with one Survivor. Every time you chase your Obsession and let them escape, you receive a Token up to a maximum of 3 Tokens. Each Token increases your movement speed by <span style='color:green'>3</span>/<span style='color:purple'>4</span>/<span style='color:purple'>5</span> %. Each offensive action spends one Token. Only one Obsession per match.",
								"Your acute tracking ability allows you to follow disturbances left by passing prey over a longer period of time. Footstep marks stay visible <span style='color:yellow'>1</span>/<span style='color:yellow'>2</span>/<span style='color:green'>3</span> seconds longer than normal.",
								"You become obsessed with one Survivor. As long as your Obsession is alive, after being in a chase for <span style='color:yellow'>20 seconds</span> the cooldown for your next successful attack is decreased by <span style='color:green'>30</span>/<span style='color:purple'>35</span>/<span style='color:purple'>40</span> %. Your successful attack cooldown remains active for <span style='color:yellow'>5 seconds</span> after a chase. Re-initialising a chase before the <span style='color:yellow'>5 seconds</span> have lapsed will reset the successful attack cooldown timer. Only one Obsession per match.",
								"You have a keen vision in the darkness of the night. Your vision is <span style='color:green'>25</span>/<span style='color:purple'>30</span>/<span style='color:purple'>35</span> % clearer and your field of view is <span style='color:green'>not</span>/<span style='color:purple'>slightly</span>/<span style='color:purple'>considerably </span> wider than normal. Highly sensitive to light, you get blinded <span style='color:green'>25</span>/<span style='color:purple'>30</span>/<span style='color:purple'>35</span> % faster than normal and take <span style='color:purple'>50%</span> more time to recover from this condition.",
								"You know where to hit to make them bleed. Wounds inflicted by successful attacks <span style='color:yellow'>slightly</span>/<span style='color:green'>moderately</span>/<span style='color:green'>considerably</span> increase the Survivor's bleeding frequency. Bleeding returns to normal once the Survivor is healed.",
								"The Crows found in the world can communicate directly with you. <span style='color:green'>50</span>/<span style='color:purple'>50</span>/<span style='color:purple'>75</span> % of the time, cawing Crows give you a visual clue when you are within a <span style='color:green'>16</span>/<span style='color:purple'>24</span>/<span style='color:purple'>36</span> meters.",
								"Breathing of Survivors in pain is <span style='color:yellow'>25</span>/<span style='color:yellow'>50</span>/<span style='color:green'>50</span> % louder. Regular Survivor breathing is now also <span style='color:yellow'>0</span>/<span style='color:yellow'>0</span>/<span style='color:green'>25</span> % louder.",
								"Unlocks potential in one's Aura reading ability. Survivors' Auras are revealed to you for <span style='color:yellow'>3 seconds</span> when they enter the Basement and you are more than <span style='color:orange'>32 metres</span> away from the Basement entrance. Territorial Imperative can only be triggered once every <span style='color:yellow'>60</span>/<span style='color:green'>45</span>/<span style='color:purple'>30</span> seconds.",
								"Add-ons that affect charge time of your power are <span style='color:green'>6</span>/<span style='color:purple'>8</span>/<span style='color:purple'>10</span> % more effective.",
								...
								"You recuperate faster from any attack made with your main weapon. The cooldown of missed attacks is reduced by <span style='color:yellow'>20</span>/<span style='color:green'>25</span>/<span style='color:purple'>30</span> %.",
								"You have a rudimentary understanding of the Entity's voice. Sporadically hear the Entity's Whisper when standing within a <span style='color:yellow'>48</span>/<span style='color:yellow'>40</span>/<span style='color:purple'>32</span> meters of a Survivor."];
